...
// var datatablename = '#dataTables-processus';
// var smname = 'processus';
...
//     dom: 't',
//     columns: [
//         { data: 'select', name : '', className: 'select-checkbox', orderable: false, "width": "24px", },
//         { data: 'designation', name : 'Désignation', className: "table-title" },
//         { data: 'responsable', name : 'Responsable' },
//         { data: 'type', name : 'Type' },
//         { data: 'relation', name : 'Relation' },
//         { data: 'comply', name : 'Comply' },
