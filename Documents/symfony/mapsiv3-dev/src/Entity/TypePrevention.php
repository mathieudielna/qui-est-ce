...
/**
 * @ORM\Entity(repositoryClass="App\Repository\TypePreventionRepository")
 */
class TypePrevention
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\MapsiCustomer", inversedBy="typePreventions")
     */
    private $customer;

    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\ObjetMetier", mappedBy="mesuresprev")
     */
    ...
    public function addObjetMetier(ObjetMetier $objetMetier): self
    {
        if (!$this->objetMetiers->contains($objetMetier)) {
            ...
            $objetMetier->addMesuresprev($this);
        }
    ...
    public function removeObjetMetier(ObjetMetier $objetMetier): self
    {
        if ($this->objetMetiers->contains($objetMetier)) {
            ...
            $objetMetier->removeMesuresprev($this);
        }
