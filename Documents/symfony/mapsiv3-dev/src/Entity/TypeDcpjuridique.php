...
/**
 * @ORM\Entity(repositoryClass="App\Repository\TypeDcpjuridiqueRepository")
 */
class TypeDcpjuridique
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Flux", mappedBy="dcpjuridique")
     */
    private $fluxes;
