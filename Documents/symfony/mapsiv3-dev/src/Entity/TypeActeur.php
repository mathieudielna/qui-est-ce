...
/**
 * @ORM\Entity(repositoryClass="App\Repository\TypeActeurRepository")
 */
class TypeActeur
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Flux", mappedBy="personneconcerne")
     */
    private $fluxes;
    ...
    public function removeFlux(Flux $flux): self
    {
        if ($this->fluxes->contains($flux)) {
            ...
            $flux->removePersonneconcerne($this);
        }
