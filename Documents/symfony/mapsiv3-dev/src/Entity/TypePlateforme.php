...
/**
 * @ORM\Entity(repositoryClass="App\Repository\TypePlateformeRepository")
 */
class TypePlateforme
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Systeme", mappedBy="plateforme")
     */
    private $systemes;
    ...
    public function removeSysteme(Systeme $systeme): self
    {
        if ($this->systemes->contains($systeme)) {
            ...
            if ($systeme->getPlateforme() === $this) {
                $systeme->setPlateforme(null);
            }
        }
