...
/**
 * @ORM\Entity(repositoryClass="App\Repository\TypeDcpsensibleRepository")
 */
class TypeDcpsensible
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\MapsiCustomer", inversedBy="typeDcpsensibles")
     */
    private $customer;

    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Flux", mappedBy="dcpsensible")
     */
    private $fluxes;
