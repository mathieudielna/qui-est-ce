 ...
 */
final class Version20200728014956 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE flux_connect_activite ADD CONSTRAINT FK_7F7FC552129C5EF2 FOREIGN KEY (directionfx_id) REFERENCES type_direction (id)');
        $this->addSql('ALTER TABLE flux_connect_activite ADD CONSTRAINT FK_7F7FC55223321CD9 FOREIGN KEY (directionact_id) REFERENCES type_direction (id)');
