 ...
 */
final class Version20190605141913 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE systeme ADD CONSTRAINT FK_95796DE367A3C51B FOREIGN KEY (suppleant_id) REFERENCES people (id)');
