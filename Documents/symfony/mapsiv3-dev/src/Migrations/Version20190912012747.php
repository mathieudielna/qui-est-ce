 ...
 */
final class Version20190912012747 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE action ADD CONSTRAINT FK_47CC8C929D32F035 FOREIGN KEY (action_id) REFERENCES projet (id) ON DELETE SET NULL');
