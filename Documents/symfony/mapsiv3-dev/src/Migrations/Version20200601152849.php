 ...
 */
final class Version20200601152849 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE risque ADD CONSTRAINT FK_20230D2453C59D72 FOREIGN KEY (responsable_id) REFERENCES people (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE risque ADD CONSTRAINT FK_20230D2467A3C51B FOREIGN KEY (suppleant_id) REFERENCES people (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
