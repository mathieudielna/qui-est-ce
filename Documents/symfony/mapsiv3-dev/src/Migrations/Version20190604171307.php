 ...
 */
final class Version20190604171307 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE systeme ADD CONSTRAINT FK_95796DE3B656D6A2 FOREIGN KEY (dima_id) REFERENCES criticite (id)');
        $this->addSql('ALTER TABLE systeme ADD CONSTRAINT FK_95796DE399597DA1 FOREIGN KEY (pdma_id) REFERENCES criticite (id)');
