 ...
 */
final class Version20190613011553 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE metier ADD CONSTRAINT FK_51A00D8C9395C3F3 FOREIGN KEY (customer_id) REFERENCES mapsi_customer (id)');
