 ...
 */
final class Version20200212135507 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE flux ADD CONSTRAINT FK_7252313AAC07831C FOREIGN KEY (transfertue_id) REFERENCES oui_non (id)');
