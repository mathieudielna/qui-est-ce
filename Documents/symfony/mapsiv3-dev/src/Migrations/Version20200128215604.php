 ...
 */
final class Version20200128215604 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE systeme ADD CONSTRAINT FK_95796DE317DCBC2F FOREIGN KEY (systemeshost_id) REFERENCES systeme (id)');
