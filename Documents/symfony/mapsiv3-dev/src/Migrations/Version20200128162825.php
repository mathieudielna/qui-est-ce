 ...
 */
final class Version20200128162825 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE systeme ADD CONSTRAINT FK_95796DE3E7C6E2A3 FOREIGN KEY (systemehost_id) REFERENCES systeme (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
