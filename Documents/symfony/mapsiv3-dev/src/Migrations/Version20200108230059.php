 ...
 */
final class Version20200108230059 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE systeme ADD CONSTRAINT FK_95796DE35CC5DB90 FOREIGN KEY (storage_id) REFERENCES systeme (id)');
