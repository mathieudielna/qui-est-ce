 ...
 */
final class Version20201113005416 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE systeme ADD CONSTRAINT FK_95796DE3F6203804 FOREIGN KEY (statut_id) REFERENCES on_off (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
