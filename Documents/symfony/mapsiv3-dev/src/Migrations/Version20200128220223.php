 ...
 */
final class Version20200128220223 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE systeme ADD CONSTRAINT FK_95796DE31FB8D185 FOREIGN KEY (host_id) REFERENCES systeme (id)');
