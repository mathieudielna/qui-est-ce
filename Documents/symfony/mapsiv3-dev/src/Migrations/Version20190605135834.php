...
final class Version20190605135834 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE systeme DROP responsable_id, DROP responsable, DROP suppleant');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE systeme ADD responsable_id INT DEFAULT NULL, ADD responsable VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, ADD suppleant VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
