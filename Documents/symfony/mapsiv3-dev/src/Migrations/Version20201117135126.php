 ...
 */
final class Version20201117135126 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE action ADD CONSTRAINT FK_47CC8C92F6203804 FOREIGN KEY (statut_id) REFERENCES type_statut (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
