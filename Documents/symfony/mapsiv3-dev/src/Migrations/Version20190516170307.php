 ...
 */
final class Version20190516170307 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE application CHANGE description description LONGTEXT NOT NULL, CHANGE created_at created_at DATETIME NOT NULL, CHANGE responsable responsable VARCHAR(255) NOT NULL, CHANGE commentaire commentaire LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE application CHANGE description description LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE responsable responsable VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, CHANGE commentaire commentaire LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}
