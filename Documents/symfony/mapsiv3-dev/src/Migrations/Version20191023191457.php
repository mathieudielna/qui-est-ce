 ...
 */
final class Version20191023191457 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE jalon_connect_action ADD CONSTRAINT FK_57AA629B9B4C4CA FOREIGN KEY (fin_id) REFERENCES oui_non (id)');
