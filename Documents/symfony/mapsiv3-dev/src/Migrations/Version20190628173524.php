 ...
 */
final class Version20190628173524 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activite ADD CONSTRAINT FK_B875551590543251 FOREIGN KEY (mapsi_customer_id) REFERENCES mapsi_customer (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
