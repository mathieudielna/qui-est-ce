 ...
 */
final class Version20200609000330 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE application ADD CONSTRAINT FK_A45BDDC1F6203804 FOREIGN KEY (statut_id) REFERENCES on_off (id)');
