 ...
 */
final class Version20201112122942 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE objet_metier ADD CONSTRAINT FK_E47FE0A6F6203804 FOREIGN KEY (statut_id) REFERENCES type_statutrgpd (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
